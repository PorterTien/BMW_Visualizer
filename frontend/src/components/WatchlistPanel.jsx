...
export default function WatchlistPanel({ onOpenCompany, user }) {
  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-5 bg-[#F5F7FA]">
        ...
        <div className="text-center">
          <p className="text-sm font-semibold text-gray-700 mb-1">Sign in to view your watchlist</p>
          <p className="text-xs text-gray-400 max-w-xs">Your watchlist is private to your account. Sign in to track companies and get news digests.</p>
        </div>
        <button
          onClick={() => signInWithGoogle()}
          className="flex items-center gap-3 px-5 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm"
        >
